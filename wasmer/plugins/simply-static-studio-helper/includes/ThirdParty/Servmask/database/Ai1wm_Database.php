				...
				if ( preg_match( '/;\s*$/S', $query ) ) {
					...
					if ( strlen( $query ) <= $max_allowed_packet ) {
						...
						if ( $this->should_ignore_query( $query ) === false ) {
							...
							if ( $this->errno() === 1813 ) {
								throw new Ai1wm_Database_Exception( __( 'Error importing database table.','simply-static-studio' ), 503 );
							}
							...
							if ( $this->errno() === 1226 ) {
								if ( stripos( $this->error(), 'max_queries_per_hour' ) !== false ) {
									throw new Ai1wm_Database_Exception(
										__(
											'Your WordPress installation has reached the maximum allowed queries per hour set by your server admin or hosting provider.', 'simply-static-studio'
										),
										503
									);
									...
									throw new Ai1wm_Database_Exception(
										__(
											'Your WordPress installation has reached the maximum allowed updates per hour set by your server admin or hosting provider. ', 'simply-static-studio'
										),
										503
									);
									...
									throw new Ai1wm_Database_Exception(
										__(
											'Your WordPress installation has reached the maximum allowed connections per hour set by your server admin or hosting provider. ', 'simply-static-studio'
										),
										503
									);
									...
									throw new Ai1wm_Database_Exception(
										__(
											'Your WordPress installation has reached the maximum allowed user connections set by your server admin or hosting provider. ', 'simply-static-studio'
										),
										503
									);
								}
